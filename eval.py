...
word_map_file = 'path_to_data_files' + '/WORDMAP_flickr8k_5_cap_per_img_5_min_word_freq.json'  # word map, ensure it's the same the data was encoded with 
...
def evaluate(beam_size):
    ...
    print('The number of empty hypotheses in forward is {} and backward is {}'.format(empty_hypo, empty_hypo_r))
